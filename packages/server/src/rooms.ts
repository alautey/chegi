...
export interface Room {
  ...
  /** Set on checkmate or resignation — no further moves accepted. */
  over: boolean;
}
...
export class RoomManager {
  ...
  createRoom(): { room: Room; color: Color } {
    ...
    const room: Room = { id, game: new Game(), seated: { w: true, b: false }, over: false };
